...
const Main = () => {
  return (
    <div className="w-screen h-screen overflow-hidden m-0 p-0 flex flex-wrap">
      <div className="md:w-1/2 md:h-1/3 lg:w-1/3 lg:h-1/2 sm:w-1/2 xs:w-full bg-[#44C5CB] flex flex-wrap justify-center items-center">
      ...
      <div className="md:w-1/2 md:h-1/3 lg:w-1/3 lg:h-1/2 sm:w-1/2 xs:w-full bg-[#f2dd1c] flex flex-wrap justify-center items-center">
        <div className="w-auto">
      ...
      <div className="md:w-1/2 md:h-1/3 lg:w-1/3 lg:h-1/2 sm:w-1/2 xs:w-full bg-[#8E44AD] flex flex-wrap justify-center items-center">
        <div className="w-auto">
      ...
      <div className="md:w-1/2 md:h-1/3 lg:w-1/3 lg:h-1/2 sm:w-1/2 xs:w-full bg-[#F53D52] flex flex-wrap justify-center items-center">
        <div className="w-auto">
      ...
      <div className="md:w-1/2 md:h-1/3 lg:w-1/3 lg:h-1/2 sm:w-1/2 xs:w-full bg-[#FF9200] flex flex-wrap justify-center items-center">
        <div className="w-auto">
      ...
      <div className="md:w-1/2 md:h-1/3 lg:w-1/3 lg:h-1/2 sm:w-1/2 xs:w-full bg-[#16A085] flex flex-wrap justify-center items-center">
        <div className="w-auto">
