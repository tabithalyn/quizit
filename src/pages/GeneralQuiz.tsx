  ...
  return (
    <div className="w-screen h-screen overflow-hidden bg-[#44C5CB] flex flex-wrap justify-center items-center">
      <div className="w-4/5 h-4/5 bg-[#f2f6f6] rounded-2xl">
        <div className="w-full flex justify-center px-5 py-10 font-bold text-[#0c3234] text-3xl">In DC comics where does the Green Arrow (Oliver Queen) live?</div>
        <hr className="w-[87%] h-[2px] bg-[#27969c] mx-auto"></hr>
        <div className="w-full h-[55%] flex flex-wrap justify-center p-10 gap-3">
          <div className="w-full h-1/4 rounded-xl bg-[#4de0e8] flex justify-center items-center hover:bg-[#24b6be] hover:cursor-pointer transition-all hover:tracking-wide">
